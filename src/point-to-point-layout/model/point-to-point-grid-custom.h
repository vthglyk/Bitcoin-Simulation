...
#ifndef POINT_TO_POINT_GRID_HELPER_CUSTOM_H
#define POINT_TO_POINT_GRID_HELPER_CUSTOM_H
 ...
 * with p2p links
 */
class PointToPointGridHelperCustom 
{
public: 
  /**
   * Create a PointToPointGridHelperCustom in order to easily create
   ...
   *                     in the grid
   */
  PointToPointGridHelperCustom (uint32_t nRows, 
                          uint32_t nCols, int noCpus,
                          PointToPointHelper pointToPoint);

  ~PointToPointGridHelperCustom ();
...
#endif /* POINT_TO_POINT_GRID_HELPER_CUSTOM_H */
